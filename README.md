...
|---|---|
| Python package | Direct installation on Linux, macOS, or Windows |
| Docker image | A self-contained command-line environment with a small runtime image |
| Web interface | Browser-based configuration downloads, ZIP archives, and QR codes |
...
Arguments are placed after the image name:
